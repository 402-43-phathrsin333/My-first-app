...
# ส่วนที่ 3 สร้างปุ่มกดคำนวณ และ แปลผลค่า BMI
if st.button("คำนวณค่า BMI 🎯"):
    # แปลงส่วนสูงและคำนวณ BMI
    ...
    # ส่วนที่ 4 แปลผลค่า BMI ตามเกณฑ์ (ต้องย่อหน้าเข้ามาอยู่ในปุ่มกด)
    if bmi < 18.5:
