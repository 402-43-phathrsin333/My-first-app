...
# แสดงชื่อสมาชิกกลุ่มท้ายเว็บ
st.write("👥 **รายชื่อสมาชิกกลุ่ม**")
st.write("1. นาย กฤษณพัฒน์ ปิมปา เลขที่ 2 ม.4/2")
st.write("2. นาย สิงหา ทองใจ เลขที่ 8 ม.4/2")
st.write("3. นาย กวินภพ สามใจ เลขที่ 11 ม.4/2")
st.write("4. นาย ภัทรสิน ศิลธรรม เลขที่ 43 ม.4/2")
